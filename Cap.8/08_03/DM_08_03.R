...
# do depmixS4
# reacoes a uma tarefa de aval em um experimento psico
# pois existem dois estados ou a pessoa respondem
...
# se baseia na logverossimilhança mas acrescenta mais informacao
# para o ajuste
