...
# Importar os dados
data = read.csv("~/Documentos/Mineração/arquivos_de_exercicios_ciencia_dados_fundamentos_mineracao/Cap.5/05_03/AnomalyData.csv")
...
# data.science x cluster.analysis elipses de dist multi
